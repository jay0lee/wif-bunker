...
//
// Adapted from GAM's ssd.mjs for WIF Bunker code signing.
// Requires: npm install totp-generator
...
async function runSSD() {
    ...
    const certum_email = process.env.CERTUM_EMAIL || 'jay0lee@gmail.com';
